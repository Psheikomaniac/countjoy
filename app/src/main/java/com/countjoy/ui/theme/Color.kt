...
// Custom Colors
val CountdownPrimary = Color(0xFF4CAF50)
val CountdownSecondary = Color(0xFF2196F3)
val CountdownAccent = Color(0xFFFF9800)
val CountdownSuccess = Color(0xFF4CAF50)
val CountdownWarning = Color(0xFFFFC107)
val CountdownError = Color(0xFFF44336)
val CountdownInfo = Color(0xFF2196F3)

// Gradient Colors
val GradientStart = Color(0xFF6750A4)
val GradientMiddle = Color(0xFF9C88DB)
